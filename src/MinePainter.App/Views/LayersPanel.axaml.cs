...
public partial class LayersPanel : UserControl
{
    ...
    private readonly LayerDragController _drag;
    ...
    {
        InitializeComponent();
        _drag = new LayerDragController(this);
        BuildActionBar();
        ...
        LayerList.AddHandler(PointerPressedEvent, _drag.OnListPointerPressed, RoutingStrategies.Tunnel);
        LayerList.AddHandler(PointerMovedEvent, _drag.OnListPointerMoved, RoutingStrategies.Tunnel);
        LayerList.AddHandler(PointerReleasedEvent, _drag.OnListPointerReleased, RoutingStrategies.Tunnel);
        LayerList.AddHandler(PointerCaptureLostEvent, (_, _) => _drag.CancelDrag(), RoutingStrategies.Tunnel);
    }
    ...
    private void OnSelectionChanged(object? sender, SelectionChangedEventArgs e)
    {
        ...
        if (_drag.PressedNode != null && selected.Contains(_drag.PressedNode)) primary = _drag.PressedNode;
